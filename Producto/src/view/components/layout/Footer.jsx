...
export function Footer() {
  // El año se calcula una sola vez al montar con el initializer perezoso de
  // useState: corre en el navegador, sin render extra y sin new Date() en el JSX
  // (evita el aviso de hidratación y el de inicializar estado desde un efecto).
